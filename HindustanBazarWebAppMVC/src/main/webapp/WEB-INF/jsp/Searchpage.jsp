...
<body>
	        ...
	        <div class = "products">
            <div class = "container">
                <h1 class = "lg-title">Showing Result for the Search "<font color="red"> ${keyword } </font>"</h1>
                <p class = "text-light"><i>${count } results found</i>
                    ...
                    <div class = "product">
                        <div class = "product-content">
                            ...
                            <div class = "product-btns">
                            	<form action="addtowishlistSearch" method="post">
                        ...
                        <div class = "product-info">
                           ...
                           <c:if test="${product.getProductQtyAvailable() == 0}">
                       			<form action="quantityCheckSearch" method="post">

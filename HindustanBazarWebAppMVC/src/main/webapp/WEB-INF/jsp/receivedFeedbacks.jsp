...
<title>Hindustan Bazar | Feedbacks Received</title>
...
<div class="container px-1 px-md-4 py-5 mx-auto" >
	<div class="card" >
        <div class="row d-flex justify-content-between px-3 top">
            <div class="d-flex">
                <h1>FEEDBACKS RECEIVED <span class="text-primary font-weight-bold"></span></h1>
            </div>
    ...
    <div class="card">
        <div class="row d-flex justify-content-between px-3 top">
            ...
            <div class="d-flex">
                <h6><span class="text-primary font-weight-bold">Posted by ID : </span>${feedback.getBuyerID() }</h6>
            </div>
             <div class="d-flex">
